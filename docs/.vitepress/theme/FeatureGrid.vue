 ...
 * rounded boast: 567 chunks × 1536 dims × 1 byte = 870,912 bytes, which is
...
const sizes = [
  ...
  { label: 'int8', bytes: '851 KB', width: '25%', dim: false },
]
</script>
  ...
  >
    ...
    <div class="flex flex-col gap-3 justify-between">
      ...
      <div class="p-5 sm:p-15 flex flex-col gap-5">
        ...
        <p class="text-sm">
          This site's own index &mdash; 567 chunks at 1536 dimensions, one signed
