...
For scale: this documentation site indexes 471 chunks at 2048 dimensions, so its vector blob is 964,608 bytes — 942 KB, where float32 would have been 3.7 MB.
