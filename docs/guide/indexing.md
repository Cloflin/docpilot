...
For scale: this documentation site indexes 570 chunks at 1536 dimensions, so its vector blob is 875,520 bytes — 855 KB, where float32 would have been 3.3 MB.
