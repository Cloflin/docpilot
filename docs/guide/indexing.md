...
For scale: this documentation site indexes 580 chunks at 1536 dimensions, so its vector blob is 890,880 bytes — 870 KB, where float32 would have been 3.4 MB.
