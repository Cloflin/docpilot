...
For scale: this documentation site indexes 484 chunks at 2048 dimensions, so its vector blob is 991,232 bytes — 968 KB, where float32 would have been 3.8 MB.
