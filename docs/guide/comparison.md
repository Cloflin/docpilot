...
| **Index the reader downloads** | int8 vectors, one byte per dimension — 968 KB for this site's 484 chunks at 2048 dimensions | n/a — the index is theirs | n/a — the index is theirs | n/a — the index is theirs | n/a — the index is theirs | n/a, unless you ship an OSS bundle |
...
a test in this repository. The index figures — 484 chunks, 2048 dimensions,
968 KB of int8 vectors, under 0.003 mean |Δcos| — describe the files this page
