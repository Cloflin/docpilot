...
| [014](014-the-key-that-stopped-the-answer.md) | Enter during a running turn no longer throws the answer away; the composer stops being the thing that enforces one turn at a time |
