...
export function record(
  entry,
  {feedbackEndpoint, send = FEEDBACK_DEFAULTS.send, debug = false, storage, fetchImpl} = {},
) {
...
export function all(storage) {
  return read(storage)
}

export function exportJsonl(storage) {
  return read(storage)
...
export function installConsoleHelper() {
  ...
  w.__docPilot = Object.assign(w.__docPilot || {}, {
    feedback: () => all(),
    exportFeedback() {
