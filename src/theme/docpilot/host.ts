...
import { getCurrentInstance, inject, ref, shallowRef, type InjectionKey } from 'vue'
import type {
  HostBinding,
  HostEnvironment,
  HostRouter,
...
import type { DocPilotThemeConfig } from '../../../types/config.js'
 ...
 */
export const HOST_KEY: InjectionKey<() => HostBinding> = Symbol.for('docpilot.host')
